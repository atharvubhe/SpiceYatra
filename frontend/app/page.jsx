...
import { ArrowRight, Car, Clock, Flame, Star, Users} from "lucide-react";
  ...
  return (
   ...
   <section className=" pt-32 pb-20 px-4">
    ...
    <div className="flex-1 text-center md:text-left">
      ...
      <p className="text-xl md:text-2x1 text-stone-600 mb-10 max-w-lg mx-auto md:mx-0 font-light">
...
Save money, reduce waste, and eat better tonight.
   ...
   <section  className="py-12 border-y-2 border-stone-900 bg-stone-900">
    <div className="max-w-5x1 mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center px-4">
    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-16">
        <h2 className="text-5xl md:text-6xl font-bold mb-4">
          ...
          <p className="text-stone-600 text-xl font-light">Everything you need to master your meal prep.
